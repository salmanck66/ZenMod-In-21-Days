...
const LifeSuccessJourney = () => {
  ...
  const themeConfig = {
    dark: {
      ...
      levelBg: 'bg-gradient-to-br from-gray-700 to-gray-900',
      levelBorder: 'border-gray-500',
      progressBg: 'bg-gray-700',
      progressFill: 'bg-white',
      btnPrimary: 'bg-gradient-to-r from-gray-700 to-gray-900 border-gray-500',
      btnSecondary: 'bg-white text-black',
      inputBg: 'bg-gray-700',
      inputBorder: 'border-gray-400',
      hoverBg: 'hover:bg-white hover:text-black',
      completionBg: 'bg-gradient-to-br from-gray-700 to-gray-900 border-gray-500'
    },
    light: {
      name: 'Light',
      bg: 'bg-white',
...
export default LifeSuccessJourney;import React, { useState, useEffect } from 'react';
import { Clock, Plus, Trash2, Trophy, Target, Star, Settings } from 'lucide-react';
